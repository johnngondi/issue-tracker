<template>
    <default-page title="Add New System"
                  content="Fill in the form Below to create new System."
    >
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            this.statusTitle = 'Adding System';
            this.statusContent = 'Hold on while we add system...';
            this.showStatus = true;

            //
            axios.post(route('systems.store'), this.builder)
                .then(({status, data}) => {
                    // handle success
                    if (status === 200){
        ...
        showSuccessStatusModal() {
            ...
            this.statusTitle = 'System Added Successfully.';
            this.statusContent = 'The system has been deleted successfully!';
            this.showStatus = true;
        ...
        showErrorStatusModal() {
            ...
            this.statusTitle = 'System not Added.';
